// call function to load notes on refresh and new start of the app
showNotes();

// Function to add note on the click of button in the local storage
...
function showNotes(){
    ...
    if(notesObj.lenght != 0){
        ...
        notesEml.innerHTML = `Nothing to show! Pleasw use add note section to create notes.`;
    }
}
...
// Function to search notes using search bar
